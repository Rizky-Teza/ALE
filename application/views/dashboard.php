    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img src="<?php echo base_url('assets/img/sliderr.jpg') ?>" class="d-block w-100" alt="...">
            </div>
        </div>
        ...
        <?php foreach ($barang as $brg) : ?>
            ...
            <div class="card ml-3" style="width: 17rem;">
                ...
                <div class="card-body">
                    ...
                    <?php echo anchor('dashboard/tambah_ke_keranjang/'.$brg->id_brg,'<div class="btn btn-sm btn-primary"><i class="fas fa-cart-plus"></i></div>') ?>
                </div>
            </div>
            </div>
        <?php endforeach; ?>
